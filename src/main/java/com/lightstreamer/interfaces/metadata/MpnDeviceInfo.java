...
public class MpnDeviceInfo {
     ...
     * @param applicationId the application ID, also known as the package name or bundle ID on some platforms.
     * @param deviceToken the token of the device, also know as the registration ID on some platforms.
     */
    public MpnDeviceInfo(
    		@Nonnull MpnPlatformType type,
